...
module Main {
    export let facebookParams = $.extend({}, Config.Params.DetailsDefaults);
    export let edgeParams = $.extend({}, Config.Params.DetailsDefaultsEdge);
    ...
    export function setupDetailsForDomainEdgeMock(): void {
        // Get details for domain
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.DetailsForDomain].join("/"),
            responseText: getMockDetailsForDomainEdge(),
            data: (data) => {
                return data.domain === edgeParams.domain;
            }
        });
    }

    export function setupFiltersMock(): void {
        // Get filters
        $.mockjax({
    ...
    export function setupFiltersEdgeMock(): void {
        // Get filters
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.Filters].join("/"),
            responseText: getMockFiltersData(),
    ...
    export function setupBugsForDomainBlobUrlMock(): void {
        $.mockjax({
    ...
    export function setupBugsForDomainBlobUrlEdgeMock(): void {
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.BugsForDomain].join("/"),
            responseText: getMockBugsForDomainBlobUrlEdge(),
            data: (data) => {
                return data.domain === edgeParams.domain;
            }
        });
    ...
    export function setupBugsForDomainMock(): void {
        $.mockjax({
    ...
    export function setupBugsForDomainEdgeMock(): void {
        $.mockjax({
            url: getMockBugsForDomainBlobUrlEdge(),
            responseText: getMockBugsForDomainEdge()
        });
    }

    export function setupScanTimeMock(): void {
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.ScanTime].join("/"),
            responseText: getMockScanTime()
        });
    }

    export function setupScanTimeEdgeMock(): void {
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.ScanTime].join("/"),
            responseText: getMockScanTime(),
            data: (data) => {
    ...
    export function setupBuildWithDataForDomainMock(): void {
        $.mockjax({
    ...
    export function setupBuildWithDataForDomainEdgeMock(): void {
        // Get builtwith data
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.BuiltWithDataForDomain].join("/"),
            responseText: getMockBuiltWithDataForDomainEdge(),
            data: (data) => {
                return data.domain === edgeParams.domain;
            }
        });
    ...
    export function setupBugTrendsBlobUrlMock(): void {
    ...
    export function setupBugTrendsBlobUrlEdgeMock(): void {
        // Get URL for bug trends for domain blob
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.BugTrends].join("/"),
            responseText: getMockBugTrendsBlobUrl(),
    ...
    export function setupBugTrendsMock(): void {
    ...
    export function setupBugTrendsEdgeMock(): void {
        // Get bug trends for domain blob
        $.mockjax({
            url: getMockBugTrendsBlobUrl(),
            responseText: getMockBugTrends(),
    ...
    export function setupTrendsForDomainMock(): void {
    ...
    export function setupTrendsForDomainEdgeMock(): void {
        // Get trends for domain
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.TrendsForDomain].join("/"),
            responseText: getMockTrendsForDomainDataRs1Edge(),
            data: (data) => {
                return data.domain === edgeParams.domain
                    && data.release === edgeParams.release;
            }
        });
    }

    export function setupTrendsForDomainTh2Mock(): void {
        $.mockjax({
            url: [Config.Urls.SiteReporterApi, Config.Endpoints.TrendsForDomain].join("/"),
    ...
    export function getMockBugsForDomainBlobUrl(): string {
    ...
    export function getMockBugsForDomainBlobUrlEdge(): string {
        return "https://iesitereporter.blob.core.windows.net/domains/bugdetails/randomsite.com/rs1?sv=2015-12-11&sr=c&si=readonlypolicy&sig=iwF9pG3aodocqS1umTVv0O6umJM53SDaqO9wEjamy4w%3D";
    }

    export function getMockScanTime(): string {
        return "2016-08-05T18:36:21.6588749+00:00";
    }

    export function getMockBugsForDomain(): BugsForDomainRepo.DataTransferObject {
        return {
            "IsSwitchRisk": true,
            "Bugs": [
                {
    ...
    export function getMockBuiltWithDataForDomain(): BuiltWithDataForDomainRepo.DataTransferObject  {
        return {
    ...
    export function getMockBuiltWithDataForDomainEdge(): BuiltWithDataForDomainRepo.DataTransferObject {
        return {
            "identifier": "facebook.com",
            "technologies": []
        };
    ...
    export function getMockBugTrendsBlobUrl(): string {
    ...
    export function getMockBugTrends(): BugTrendsRepo.DataTransferObject {
        return {
    ...
    export function getMockDetailsForDomain(): DetailsForDomainRepo.DataTransferObject {
        return {
    ...
    export function getMockDetailsForDomainEdge(): DetailsForDomainRepo.DataTransferObject {
        return {
            "domainName": "facebook.com",
            "isOffensive": false,
            "domainId": 200,
    ...
    export function getMockTrendsForDomainDataRs1Edge(): TrendsForDomainRepo.DataTransferObject {
        return {
            "charts": []
        };
    }

    export function getMockTrendsForDomainDataTh2(): TrendsForDomainRepo.DataTransferObject {
