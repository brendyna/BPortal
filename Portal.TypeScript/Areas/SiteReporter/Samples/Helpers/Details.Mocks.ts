...
module Main {
    ...
    export function getMockBugsForDomainEdge(): any {
        return {
            "IsSwitchRisk": false,
            "Bugs": [
                {
                    "Domain": "facebook.com",
                    "Title": "apps.facebook.com : Pagessss goes \"not responding\" as you start playing game. Unable to play game. keeps on hanging.",
                    "Id": 8248297,
                    "Keywords": "interop0",
                    "Tags": "FH_14393; Mindtree; publicregression; RSEdgeScrub2; RSEdgeScrub2_Repro",
                    "AssignedTo": "Ujesh Nambiar",
